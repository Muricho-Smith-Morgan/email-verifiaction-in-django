...
def verify_email(request):
    if request.method == "POST":
        if request.user.email_is_verified != True:
            ...
            message = render_to_string('app/verify_email_message.html', {
                'request': request,
                'user': user,
...
def verify_email_done(request):
    return render(request, 'app/verify_email_done.html')
...
def verify_email_confirm(request, uidb64, token):
    ...
    return render(request, 'app/verify_email_confirm.html')
